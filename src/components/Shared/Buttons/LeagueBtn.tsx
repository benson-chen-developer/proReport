...
export const LeagueBtn: React.FC<Props> = ({currLeague, selectedLeague, func}) => {
    const {isMobile} = useGlobalContext();
    const [hovered, setHovered] = useState(false);
    const isPicked = currLeague.toLowerCase() === selectedLeague.toLowerCase();
    ...
    return (
        <div 
            ...
            onClick={() => {
                if (selectedLeague.toLowerCase() !== currLeague.toLowerCase()) {
                    func(currLeague);
                }
            }}
        >
