...
export const ProjectionSquare: React.FC<Props> = ({pickedProjection, setPickedProjection, filter, setFilter}) => {
    ...
    return (
        <div>
            <div 
                style={{
                    width: isMobile ? "115px" : '150px', height: isMobile ? '25px' : '30px', borderRadius:'8px',
            ...
            {isPopUp ?
                <div 
                    style={{
                        width: isMobile ? "115px" : '150px', background:'#000', borderRadius:'5px', border:'1px solid #5B5B5B',
