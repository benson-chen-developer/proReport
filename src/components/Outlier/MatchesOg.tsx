...
export const MatchesOG: React.FC<Props> = ({loading, setLoading}) => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            if(!player) { 
                ...
                setPickedProjection(initialPickedProjection);
                ...
                newFilters = getNewStatsForFilters(
                    false, 
                    projections, 
                    initialPickedProjection, 
                    filters, 
                    player
                );
                // }
    ...
    */
    const getValidFiltersAndPickedProjection = (): {pickedProjection : Projection | null, filter: Filter} => {
