...
export const PromoItem: React.FC<Props> = ({promo, toastFunc}) => {
    ...
    return (
        <div 
            style={{
                width:'100%', height:'110px', borderRadius:'5px', 
                background:'#262626', 
        ...
        >
            <div style={{width:'95%', display:'flex', alignItems:'center'}}>
                ...
                <div style={{marginLeft:'20px', width:'30%'}}>
                    <p style={{fontSize:'14px', color:'#B1B1B1', margin:'5px 0px 10px 0px'}}>{promo.sportsbook}</p>
                    <p style={{fontSize:'22px', color:'#fff', margin:'0px 0px 10px 0px'}}>{promo.signUp}</p>
                </div>

                <div style={{width:'40%', display:'flex', alignItems:'center'}}>
                    <p style={{fontSize:'14px', color:'#B1B1B1'}}>{promo.description}</p>
                </div>

                <div style={{display:'flex', alignItems:'flex-end', flexDirection:'column', justifyContent:'space-evenly', height:'100%', marginLeft:'auto'}}>
                    {/* Claim Btn */}
                    <div style={{
                        width:'80px', height:'35px', borderRadius:'5px',
                    ...
                    <div 
                        style={{
                            width:'auto', height:'35px', borderRadius:'5px',
